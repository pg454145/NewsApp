...
const News = (props) => {
  ...
  const updateNews = async (page = 1) => {
    ...
    // ✅ Proxy call to Netlify Function
    let url = `/.netlify/functions/fetchNews?country=${props.country}&category=${props.category}&page=${page}&pageSize=${props.pageSize}`;
  ...
  const fetchMoreData = async () => {
    ...
    let url = `/.netlify/functions/fetchNews?country=${props.country}&category=${props.category}&page=${nextPage}&pageSize=${props.pageSize}`;
